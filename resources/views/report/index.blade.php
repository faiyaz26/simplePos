                    ...
                    <div class="panel-body">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h2 class="text-center">Report from {{$data['startDate']->format('j F, Y')}} to {{ $data['endDate']->format('j F, Y') }}</h2>
                                    </div>
                                </div>
                                </br>
                                <div class="row">
                                    <div class="col-md-10 col-md-offset-2">
                                        <form class="form-inline">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class= "form-control datepicker" name ="startDate" id="startDate" value="{{$data['startDate']->format('Y-m-d')}}"/>
                                            </div>
                                            <div class="form-group">
                                                <label for="endDate">End Date</label>
                                                <input type="text" class= "form-control datepicker" name="endDate" id="endDate" value="{{$data['endDate']->format('Y-m-d')}}"/>
                                            </div>
